...
export default function AlertModal({message, onCancel, onConfirm}: AlertModalProps) {
  return (
    <div >  
      ...
      <div style={{zIndex: 1, borderRadius: "0.5rem", backgroundColor: "white", padding: "1.5rem 2rem", position: "absolute", top: "50%", left: "50%", right: "auto", bottom: "auto", transform: "translate(-50%, -50%)"}}>
