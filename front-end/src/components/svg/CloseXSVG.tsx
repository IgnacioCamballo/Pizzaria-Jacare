...
export default function CloseXSVG({onClick, className}: ArrowSVGProps) {
  return (
    <svg onClick={onClick} className={className} width={16} height={16} viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" fill="#000000" stroke="#000000" strokeWidth="0.5200000000000006">
